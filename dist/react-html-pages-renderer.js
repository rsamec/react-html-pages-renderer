(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.HtmlPagesRenderer = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
/**
 * @license
...
var ArrayObjectBinding = (function () {
    function ArrayObjectBinding(sourceObject, provider, path, notifyChange) {
        this.sourceObject = sourceObject;
        this.provider = provider;
        this.path = path;
        this.notifyChange = notifyChange;
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				containers.length !== 0 ? _react2['default'].createElement(containerComponent, nodeProps, containers.map(function (container, index) {
					...
					return _react2['default'].createElement(childComponent, _lodash2['default'].extend({
						child: true,
						key: key,
						name: container.name
					}, childProps), _react2['default'].createElement(ContainerRenderer, { key: key,
						index: index,
						left: left,
						top: top,
...
},{"./utils/backgroundStyle":9,"./utils/generateCssTransform":11,"lodash":1}],5:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./utils/backgroundStyle":9,"lodash":1}],6:[function(require,module,exports){
(function (global){
'use strict';
...
var HtmlPagesRenderer = (function (_React$Component) {
	...
	_createClass(HtmlPagesRenderer, [{
		...
		value: function render() {
			...
			}) : (0, _utilsTransformToPages2['default'])(_lodash2['default'].cloneDeep(schema), pageHeight);
			...
			var createBoxedPage = (function (page, i) {
				return React.createElement(
					...
					{ key: 'page' + i, position: i, pageNumber: page.pageNumber, widgets: widgets,
						background: page.pageBackground, pageOptions: pageOptions },
			...
			var createGridPage = function createGridPage(page, i) {
				return React.createElement(
					_HtmlPageJs2['default'],
					{ key: 'page' + i, position: i, pageNumber: page.pageNumber, widgets: widgets,
						background: page.pageBackground, pageOptions: pageOptions, title: 'Page ' + i },
...
},{"./ContainerRenderer.js":4,"./HtmlPage.js":5,"./HtmlRenderer":7,"./WidgetRenderer":8,"./utils/bindToSchema":10,"./utils/transformToPages":12,"lodash":1,"react-dom":undefined}],7:[function(require,module,exports){
(function (global){
'use strict';
...
var HtmlRenderer = (function (_React$Component) {
	...
	_createClass(HtmlRenderer, [{
		...
		value: function render() {
			...
			var containerRenderer = React.createElement(_ContainerRendererJs2['default'], { elementName: schema.elementName,
...
},{"./ContainerRenderer.js":4,"./WidgetRenderer":8}],8:[function(require,module,exports){
(function (global){
'use strict';
...
var WidgetRenderer = (function (_React$Component) {
	...
	_createClass(WidgetRenderer, [{
		...
		value: function render() {
			...
			var props = _lodash2['default'].merge(_lodash2['default'].cloneDeep(widget.defaultProps) || {}, box.props);
...
WidgetRenderer.bindProps = function (clonedProps, bindings, dataBinder, isDesignMode, prevDataState) {
	var props = clonedProps;
	if (bindings === undefined) return clonedProps;
...
},{"lodash":1,"react-binding":2}],9:[function(require,module,exports){
"use strict";
...
},{"lodash":1,"react-binding":2,"traverse":3}],11:[function(require,module,exports){
'use strict';
...
},{"./generateCssTransform":11,"lodash":1,"traverse":3}]},{},[6])(6)
});