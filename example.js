...
var _widgetsHtmlContent = require('./widgets/HtmlContent');

var _widgetsHtmlContent2 = _interopRequireDefault(_widgetsHtmlContent);

var _widgetsArticleContent = require('./widgets/ArticleContent');

var _widgetsArticleContent2 = _interopRequireDefault(_widgetsArticleContent);

var _widgetsListItemContent = require('./widgets/ListItemContent');

var _widgetsListItemContent2 = _interopRequireDefault(_widgetsListItemContent);

//core boxes

var _widgetsBackgroundBox = require('./widgets/BackgroundBox');

var _widgetsBackgroundBox2 = _interopRequireDefault(_widgetsBackgroundBox);

var _widgetsHtmlBox = require('./widgets/HtmlBox');

var _widgetsHtmlBox2 = _interopRequireDefault(_widgetsHtmlBox);

var _widgetsHtmlImageBox = require('./widgets/HtmlImageBox');

var _widgetsHtmlImageBox2 = _interopRequireDefault(_widgetsHtmlImageBox);

//core image

var _widgetsImageBox = require('./widgets/ImageBox');

var _widgetsImageBox2 = _interopRequireDefault(_widgetsImageBox);

var _widgetsSmartImageBox = require('./widgets/SmartImageBox');

var _widgetsSmartImageBox2 = _interopRequireDefault(_widgetsSmartImageBox);

//flex box

var _widgetsImageFlexBox = require('./widgets/ImageFlexBox');

var _widgetsImageFlexBox2 = _interopRequireDefault(_widgetsImageFlexBox);

//text box input

var _widgetsTextBoxInput = require('./widgets/TextBoxInput');

var _widgetsTextBoxInput2 = _interopRequireDefault(_widgetsTextBoxInput);

exports['default'] = {
  "Core.HtmlContent": _widgetsHtmlContent2['default'],
  "Core.ArticleContent": _widgetsArticleContent2['default'],
  "Core.ListItemContent": _widgetsListItemContent2['default'],

  "Core.ImageBox": _widgetsImageBox2['default'],
  "Core.SmartImageBox": _widgetsSmartImageBox2['default'],

  "Core.BackgroundBox": _widgetsBackgroundBox2['default'],
  "Core.HtmlBox": _widgetsHtmlBox2['default'],
  "Core.HtmlImageBox": _widgetsHtmlImageBox2['default'],

  "Core.ImageFlexBox": _widgetsImageFlexBox2['default'],

  "Core.TextBoxInput": _widgetsTextBoxInput2['default']
};
module.exports = exports['default'];

},{"./widgets/ArticleContent":3,"./widgets/BackgroundBox":4,"./widgets/HtmlBox":5,"./widgets/HtmlContent":6,"./widgets/HtmlImageBox":7,"./widgets/ImageBox":8,"./widgets/ImageFlexBox":9,"./widgets/ListItemContent":10,"./widgets/SmartImageBox":11,"./widgets/TextBoxInput":12}],2:[function(require,module,exports){
'use strict';
...
var _reactHtmlPagesRenderer = require('react-html-pages-renderer');

var _reactHtmlPagesRenderer2 = _interopRequireDefault(_reactHtmlPagesRenderer);
...
var HtmlBook = (function (_React$Component) {
	...
	function HtmlBook(props) {
		_classCallCheck(this, HtmlBook);

		_get(Object.getPrototypeOf(HtmlBook.prototype), 'constructor', this).call(this, props);
		this.state = {
			loaded: false
		};
	}

	_createClass(HtmlBook, [{
		...
		value: function render() {
			if (!this.state.loaded) return _react2['default'].createElement(
				'div',
				null,
				'Loading...'
			);
			if (this.state.error !== undefined && this.state.error.hasError) return _react2['default'].createElement(
				'div',
				null,
			...
			var dataContext = _reactBinding2['default'].bindToState(this, 'data');
...
_react2['default'].createElement(
	...
	_react2['default'].createElement(
		...
		_react2['default'].createElement(_reactRouter.Route, { path: 'book/:id', component: HtmlBook })
	)
), document.getElementById('app'));

},{"./WidgetFactory":1,"react":undefined,"react-binding":39,"react-dom":undefined,"react-html-pages-renderer":undefined,"react-router":67}],3:[function(require,module,exports){
'use strict';
...
var _utilsFont = require('./utils/font');

var _utilsFont2 = _interopRequireDefault(_utilsFont);
...
var Box = function Box(props) {
	...
	(0, _utilsFont2['default'])(textStyle, props.font);
	...
	return _react2['default'].createElement(
		'article',
		{ style: style },
		_react2['default'].createElement('div', { style: textStyle, dangerouslySetInnerHTML: { __html: props.content } })
	);
};
...
},{"./utils/font":15,"lodash":36,"react":undefined}],4:[function(require,module,exports){
'use strict';
...
var _utilsBorder = require('./utils/border');

var _utilsBorder2 = _interopRequireDefault(_utilsBorder);

var Panel = function Panel(props) {

	var style = (0, _utilsBackgroundStyle2['default'])(props.background);

	(0, _utilsBorder2['default'])(style, props.border);
...
},{"./utils/backgroundStyle":13,"./utils/border":14,"react":undefined}],5:[function(require,module,exports){
'use strict';
...
var Box = function Box(props) {
	...
	if (props.background !== undefined) bgStyle = _lodash2['default'].extend(bgStyle, (0, _utilsBackgroundStyle2['default'])(props.background));

	//border
	(0, _utilsBorder2['default'])(bgStyle, props.border);
	...
	return _react2['default'].createElement(
		...
		_react2['default'].createElement(_HtmlContent2['default'], { style: pStyle, content: props.content, font: props.font })
	);
};
Box.defaultProps = { content: 'type your content' };
exports['default'] = Box;
...
},{"./HtmlContent":6,"./utils/backgroundStyle":13,"./utils/border":14,"./utils/font":15,"lodash":36,"react":undefined}],6:[function(require,module,exports){
'use strict';
...
var HtmlBox = function HtmlBox(props) {

	var style = props.style || {};

	(0, _utilsFont2['default'])(style, props.font);

	//size
	if (props.height) style.height = props.height;
	if (props.width) style.width = props.width;

	return _react2['default'].createElement('div', { style: style, dangerouslySetInnerHTML: { __html: props.content } });
};
...
},{"./utils/font":15,"lodash":36,"react":undefined}],7:[function(require,module,exports){
'use strict';
...
var HtmlImagePanel = function HtmlImagePanel(props) {
	...
	//text style
	var pStyle = (0, _utilsFont2['default'])(props.font);
	...
	return _react2['default'].createElement(
		...
		_react2['default'].createElement('div', { style: pStyle, dangerouslySetInnerHTML: { __html: props.content } })
	);
};
var DEFAULT_IMAGE_URL = "data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==";
...
exports['default'] = HtmlImagePanel;
module.exports = exports['default'];

},{"./utils/backgroundStyle":13,"./utils/font":15,"lodash":36,"react":undefined}],8:[function(require,module,exports){
'use strict';
...
var ImageBox = function ImageBox(props) {
	...
	return _react2['default'].createElement('img', { src: props.url, style: style });
};
var DEFAULT_IMAGE_URL = "data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==";
...
},{"./utils/border":14,"react":undefined}],9:[function(require,module,exports){
'use strict';
...
var Box = function Box(props) {
	...
	//border
	(0, _utilsBorder2['default'])(style, props.border);
	if (!_lodash2['default'].isArray(props.images)) return _react2['default'].createElement('div', null);
	return _react2['default'].createElement(
		'div',
		{ style: style },
		props.images.map(function (image, index) {

			var imageProps = _lodash2['default'].extend({ url: image.url, flexGrow: index % 3, minWidth: 0, minHeight: 0 }, props.image);
			return _react2['default'].createElement(_ImageBox2['default'], _extends({ key: index }, imageProps));
		})
	);
};
var DEFAULT_IMAGE_URL = "data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==";
...
},{"./ImageBox":8,"./utils/border":14,"lodash":36,"react":undefined}],10:[function(require,module,exports){
'use strict';
...
var Box = function Box(props) {
	...
	var textStyle = (0, _utilsFont2['default'])(style, props.font);
	...
	return _react2['default'].createElement(
		'div',
		{ style: style },
		_react2['default'].createElement('div', { className: 'nestedList', style: textStyle, dangerouslySetInnerHTML: { __html: props.content } })
	);
};
...
},{"./utils/font":15,"lodash":36,"react":undefined}],11:[function(require,module,exports){
'use strict';
...
var Box = function Box(props) {
	...
	//font
	var fontStyle = {};
	(0, _utilsFont2['default'])(fontStyle, props.font);
	...
	return _react2['default'].createElement(
		'article',
		{ className: 'caption' },
		_react2['default'].createElement('img', { style: style, className: 'caption__media', src: props.url }),
		_react2['default'].createElement(
			'div',
			{ style: fontStyle, className: 'caption__overlay' },
			_react2['default'].createElement(
				'h1',
				{ className: 'caption__overlay__title' },
				props.caption
			),
			_react2['default'].createElement('p', { className: 'caption__overlay__content', dangerouslySetInnerHTML: { __html: props.description } })
		)
	);
};
var DEFAULT_IMAGE_URL = "data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==";
...
},{"./utils/border":14,"./utils/font":15,"react":undefined}],12:[function(require,module,exports){
'use strict';
...
exports['default'] = function (props) {
	...
	return _react2['default'].createElement(
		...
		null,
		props.label,
		_react2['default'].createElement('input', { type: 'text', defaultValue: props.value, value: value, placeholder: props.placeholder,
...
exports["default"] = function (source, panelSize) {
	var bg = source;
	var bgStyle = {};
	...
	if (bgGradient !== undefined) {
		...
		if (bgGradient.stops !== undefined) {
			var gradientStops = _lodash2["default"].reduce(bgGradient.stops, function (memo, stop) {
...
},{"lodash":36}],14:[function(require,module,exports){
'use strict';
...
function styleFont(style, fontProps) {

	if (style === undefined) style = {};
	if (fontProps === undefined) return style;

	style = _lodash2['default'].extend(style, fontProps) || {};
...
},{"lodash":36}],16:[function(require,module,exports){
...
},{"_process":37,"warning":75}],22:[function(require,module,exports){
'use strict';
...
},{"_process":37,"warning":75}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./DOMStateStorage":21,"./DOMUtils":22,"./ExecutionEnvironment":23,"./PathUtils":24,"./createDOMHistory":26,"_process":37,"invariant":35}],26:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":22,"./ExecutionEnvironment":23,"./createHistory":28,"_process":37,"invariant":35}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./DOMStateStorage":21,"./DOMUtils":22,"./ExecutionEnvironment":23,"./PathUtils":24,"./createDOMHistory":26,"_process":37,"invariant":35,"warning":75}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./AsyncUtils":20,"./PathUtils":24,"./createLocation":29,"./deprecate":31,"./runTransitionHook":32,"_process":37,"deep-equal":16,"warning":75}],29:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./PathUtils":24,"_process":37,"warning":75}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./PathUtils":24,"./createHistory":28,"_process":37,"invariant":35,"warning":75}],31:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":37,"warning":75}],32:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":37,"warning":75}],33:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./ExecutionEnvironment":23,"./PathUtils":24,"./deprecate":31,"./runTransitionHook":32}],34:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PathUtils":24,"./deprecate":31,"./runTransitionHook":32,"_process":37,"query-string":38,"warning":75}],35:[function(require,module,exports){
(function (process){
/**
...
},{"strict-uri-encode":74}],39:[function(require,module,exports){
/**
...
},{"./PropTypes":48,"./warning":73,"_process":37}],42:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./Link":46,"react":undefined}],43:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PropTypes":48,"./Redirect":49,"./warning":73,"_process":37,"invariant":35,"react":undefined}],44:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PropTypes":48,"./RouteUtils":52,"./warning":73,"_process":37,"invariant":35,"react":undefined}],45:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./warning":73,"_process":37,"invariant":35,"react":undefined}],46:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./warning":73,"_process":37,"react":undefined}],47:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":37,"invariant":35}],48:[function(require,module,exports){
'use strict';
...
},{"react":undefined}],49:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PatternUtils":47,"./PropTypes":48,"./RouteUtils":52,"_process":37,"invariant":35,"react":undefined}],50:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PropTypes":48,"./RouteUtils":52,"_process":37,"invariant":35,"react":undefined}],51:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./warning":73,"_process":37,"react":undefined}],52:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./warning":73,"_process":37,"react":undefined}],53:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PropTypes":48,"./RouteUtils":52,"./RouterContext":54,"./RouterUtils":55,"./createTransitionManager":62,"./warning":73,"_process":37,"history/lib/createHashHistory":27,"history/lib/useQueries":34,"react":undefined}],54:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./RouteUtils":52,"./deprecateObjectProperties":63,"./getRouteParams":65,"./warning":73,"_process":37,"invariant":35,"react":undefined}],55:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./deprecateObjectProperties":63,"_process":37}],56:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./RouterContext":54,"./warning":73,"_process":37,"react":undefined}],57:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./AsyncUtils":40,"./warning":73,"_process":37}],58:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./createRouterHistory":61,"history/lib/createBrowserHistory":25}],59:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./PatternUtils":47}],60:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"history/lib/createMemoryHistory":30,"history/lib/useQueries":34}],61:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./useRouterHistory":71}],62:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./TransitionUtils":57,"./computeChangedRoutes":59,"./getComponents":64,"./isActive":68,"./matchRoutes":70,"./warning":73,"_process":37,"history/lib/Actions":19}],63:[function(require,module,exports){
(function (process){
/*eslint no-empty: 0*/
'use strict';
...
},{"./warning":73,"_process":37}],64:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./AsyncUtils":40}],65:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./PatternUtils":47}],66:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./createRouterHistory":61,"history/lib/createHashHistory":27}],67:[function(require,module,exports){
/* components */
'use strict';
...
},{"./History":41,"./IndexLink":42,"./IndexRedirect":43,"./IndexRoute":44,"./Lifecycle":45,"./Link":46,"./PatternUtils":47,"./PropTypes":48,"./Redirect":49,"./Route":50,"./RouteContext":51,"./RouteUtils":52,"./Router":53,"./RouterContext":54,"./RoutingContext":56,"./browserHistory":58,"./createMemoryHistory":60,"./hashHistory":66,"./match":69,"./useRouterHistory":71,"./useRoutes":72}],68:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./PatternUtils":47}],69:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./RouteUtils":52,"./RouterUtils":55,"./createMemoryHistory":60,"./createTransitionManager":62,"_process":37,"invariant":35}],70:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./AsyncUtils":40,"./PatternUtils":47,"./RouteUtils":52,"./warning":73,"_process":37}],71:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"history/lib/useBasename":33,"history/lib/useQueries":34}],72:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./createTransitionManager":62,"./warning":73,"_process":37,"history/lib/useQueries":34}],73:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":37,"warning":75}],74:[function(require,module,exports){
'use strict';
